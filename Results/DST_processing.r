...
# Load data
###################
Results <- subset(read.csv("~/PhD/Brown/Papers/BMj2015/Results/DST.csv"), Honeypot==0) # Add _Lvl2 before .csv

###################
# Load data (bad workers removed)
###################
Results <- subset(read.csv("~/PhD/Brown/Papers/BMj2015/Results/DST.csv"), Honeypot==0 &  !(WorkerId %in% c("A1BAEFJ2OG7NJ0","A1G2TVO0KVLT9P","A1MMCEU78GYAW8","A1REI6H0566OKD","A1TJE3IG2C77IC","A248P03SBIGVNH","A2HR7ZIX42FEPG","A2I7D44F4BA517","A2IICB0FDT3QE2","A2Q6XBT9ZWRWPG","A2SVFFIM1EZI9R","A30R62KFQ9RBSA","A38HCU1O9OS0C5","A3EVU40JQG68SY","A3GQEWG1AAT30G","A3H35QRODK1C4K","A3HPVFAF1U9WXK","A3NQGUINZBH5CG","A3P52V679D3Y5P","A3S5NJK6P3PGNP","A3TQZUEP9A9014","AS109WTSIA8NU","AU48KLNN53BFS","AWY5WM7BEBZD8","A997OZ3H2B3Q2","A27QCN3GYCZTPE","A31A4YKVSOYRVS","A13W8W81TPORYZ","A2PXPKUKK3E0CW")))
...
Question4Negative <- rbind(subset(Question3Positive, q4p < 1),Question3Negative)
